...
<ul class="list-group list-group-flush">
    <li class="list-group-item"><a href="{{Request::root()}}/"><strong>{{Lang::get('site.universityHome')}}</strong></a></li>
    <li class="list-group-item"><a href="{{Request::root()}}/{{$college->slug}}"><strong>@lang('site.collegeHome',['ar'=>$college->type->titleSingle, 'en'=>$college->type->titleSingleEn])</strong></a></li>
    <li class="list-group-item">
        ...
        <ul class="list-links" type="none" style="padding:0px">
            <li><a href="{{Request::root()}}/{{$college->slug}}/about"> <i class="fa fa-fw"></i>  @lang('site.aboutCollege',['ar'=>$college->type->titleSingle, 'en'=>$college->type->titleSingleEn])</a></li>
            <li><a href="{{Request::root()}}/{{$college->slug}}/vision"> <i class="fa fa-fw"></i> @lang('site.VMO')</a></li>
            @if($college->details('deanWord'))
                <li><a href="{{Request::root()}}/{{$college->slug}}/dean"> <i class="fa fa-fw"></i> @lang('site.getContent',['ar'=>$college->type->deanshipWordTitle, 'en'=>$college->type->deanshipWordTitleEn])</a></li>
            @endif
            @if($college->type->id == 1 && $college->details('regulations'))
                <li><a href="{{Request::root()}}/{{$college->slug}}/regulations"> <i class="fa fa-fw"></i> @lang('site.regulations')</a></li>
            @endif
            @if($college->type->id == 1 && $college->details('programs'))
                <li><a href="{{Request::root()}}/{{$college->slug}}/programs"> <i class="fa fa-fw"></i> @lang('site.programs')</a></li>
            @endif
