...
@section('content')
    ...
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li><a class="active">@lang('site.regulations')</a></li>
        </ol>
    </div>
    <!-- end Breadcrumb -->
                    ...
                    <section id="main-content">
                        <header>
                            <h2>
                                ...
                                @lang('site.regulations')
                            </h2>
                        </header>
                        <div class="section-content">
                            <p>
                                @if($college->details)
                                    {!! Lang::get('site.getContent', ['ar'=>$college->details->regulations, 'en' => $college->details->regulationsEn]) !!}
                                @endif
                            </p>
                        </div><!-- /.section-content -->
