                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="heading">
                            ...
                            <div class="main-heading-container">
                                <h3>@lang('site.alrayed')</h3>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                            <div class="alert alert-warning">
                                <p>هي إصدارة دورية مسجلة بالمجلس الإتحادي للمصنفات الأدبية والفنية برقم الإيداع 2012/347 وترمي إلى تحقيق جملة من الأهداف منها تقديم بيانات ومعلومات عن البنك وترصد نشاط وأخبار البنك.</p>
                            </div>
                            <?php $i=1; ?>
                            @foreach($issues as $issue)
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="team-grid">
                                        ...
                                        <span>@lang('site.getContent', ['ar'=>$issue->date, 'en'=>$issue->date])</span>
                                        <div class="social2">
