                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        <label>@lang('admin.job_title')</label>
                                        <input type="text" name="job_title" value="{{ $data->job_title }}" class="form-control required {{ $errors->has('job_title')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="password" value="" placeholder="فقط اكتب كلمة مرور جديدة إذا أردت تغيير كلمة المرور الحالية" class="form-control required {{ $errors->has('password')? 'error' : '' }}">
