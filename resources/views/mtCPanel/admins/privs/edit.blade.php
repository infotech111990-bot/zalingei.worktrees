                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="text" name="section" value="{{ $data->section }}" class="form-control required {{ $errors->has('section')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="sectionID" value="{{ $data->sectionID }}" class="form-control required {{ $errors->has('sectionID')? 'error' : '' }}">
                                    ...
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										...
										<table class="table table-bordered table-condensed">
											<tbody>
												<tr>
													<td>
														<input type="checkbox" name="dataCreate" value="1" {{ ( $data->dataCreate == 1)? 'checked=""' : '' }}>
                                        				<span>@lang('admin.admin_priv_create')</span>
													</td>
													<td>
														<input type="checkbox" name="dataUpdate" value="1" {{ ( $data->dataUpdate == 1)? 'checked=""' : '' }}>
                                        				<span>@lang('admin.admin_priv_update')</span>
													</td>
													<td>
														<input type="checkbox" name="dataDelete" value="1" {{ ( $data->dataDelete == 1)? 'checked=""' : '' }}>
