		...
		<div id="panel-1" class="panel panel-default">
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>@lang('admin.'.$page_title) - @lang('admin.add')</strong> [ {{ $parent->name }} - {{ $parent->email }} ]
				</span>
							...
							<div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        <label>@lang('admin.admins_privs')</label>
                                        <input type="text" name="section" value="{{ old('section') }}" class="form-control required {{ $errors->has('section')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        <label>@lang('admin.sub_privs')</label>
                                        <input type="text" name="sectionID" value="{{ old('sectionID') }}" class="form-control required {{ $errors->has('sectionID')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
										<label>الصلاحيات التي تود منحها للمستخدم؟</label> <br>
										<table class="table table-bordered table-condensed">
											<tbody>
												<tr>
													<td>
														<input type="checkbox" name="dataCreate" value="1" {{ (old('dataCreate') == 1)? 'checked=""' : '' }}>
                                        				<span>@lang('admin.admin_priv_create')</span>
													</td>
													<td>
														<input type="checkbox" name="dataUpdate" value="1" {{ (old('dataUpdate') == 1)? 'checked=""' : '' }}>
                                        				<span>@lang('admin.admin_priv_update')</span>
													</td>
													<td>
														<input type="checkbox" name="dataDelete" value="1" {{ (old('dataDelete') == 1)? 'checked=""' : '' }}>
