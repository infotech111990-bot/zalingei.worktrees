							...
							<div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="job_title" value="{{ old('job_title') }}" class="form-control required {{ $errors->has('job_title')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="password" value="{{ old('password') }}" class="form-control required {{ $errors->has('password')? 'error' : '' }}">
