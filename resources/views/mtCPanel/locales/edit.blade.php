                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <select name="section_id" class="form-control pointer required">
                                            <option value="1" {{ ($data->section_id == 1)? 'selected' : '' }}>Site</option>
                                            <option value="2" {{ ($data->section_id == 2)? 'selected' : '' }}>Admin</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="text" name="var" value="{{ $data->var }}" class="form-control required {{ $errors->has('var')? 'error' : '' }}">
                                        @if ($errors->has('var'))
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="text" name="ar" value="{{ $data->ar }}" class="form-control required {{ $errors->has('ar')? 'error' : '' }}">
                                        @if ($errors->has('ar'))
                                            <span class="help-block text-danger">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <input type="text" name="en" value="{{ $data->en }}" class="form-control required {{ $errors->has('en')? 'error' : '' }}">
                                        @if ($errors->has('en'))
                                            <span class="help-block text-danger">
