...
@section('php')
    @php        
		...
		$page = $parentPage.".".$childPage;
		 $folder = 'public/includes/pageAttachments';
        $parent = $data->page;
    @endphp
@endsection
...
@section('breadcrumb')
        ...
        <li> <a href="{{ mtGetRoute('show','mtCPanel.'.$parentPage,$parent->id) }}">{{ $parent->name }}</a> </li>
                            ...
                            <div class="col-md-8">
							 ...
							 <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="descEn" value="{{ $data->descEn }}" class="form-control required {{ $errors->has('descEn')? 'error' : '' }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div action="" method="post" class="dropzone" id="my-dropzone">
                                            <input type="hidden" id="pdf" name="url" value="{{ $data->url }}">
                                            <h4>أفلت الملفات هنا، أو إضغط هنا</h4>
