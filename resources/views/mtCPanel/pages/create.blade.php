							...
							<div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="title_en" value="{{ old('title_en') }}" class="form-control required {{ $errors->has('title_en')? 'error' : '' }}">
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="sub_txt" value="{{ old('sub_txt') }}" class="form-control required {{ $errors->has('sub_txt')? 'error' : '' }}">
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <input type="text" name="sub_txt_en" value="{{ old('sub_txt_en') }}" class="form-control required {{ $errors->has('sub_txt_en')? 'error' : '' }}">
                                        @if ($errors->has('sub_txt_en'))
                                            <span class="help-block text-danger">
                                                <strong>{{ $errors->first('subTxt_en') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <textarea type="text" name="txt" class="summernote form-control" data-height="200" data-lang="en-US">
                                            {!! old('txt') !!}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        ...
                                        <textarea type="text" name="txt_en" class="summernote form-control" data-height="200" data-lang="en-US">
                                            {!! old('txt_en') !!}
                                        </textarea>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="col-md-12 col-sm-12 padding-top-15">
                                        <label>@lang('admin.grid')</label>
                                        <input type="text" name="grid" value="{{ old('grid') }}" class="form-control required {{ $errors->has('grid')? 'error' : '' }}">
                                        @if ($errors->has('grid'))
                                            <span class="help-block text-danger">
                                                <strong>{{ $errors->first('grid') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
