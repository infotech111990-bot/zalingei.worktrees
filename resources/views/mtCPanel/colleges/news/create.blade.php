...
@section('php')
    @php
        ...
        $folder = 'public/includes/colleges/'.$parent->id.'/news';
    @endphp
@endsection
							...
							<div class="col-md-8">
								...
								<div class="form-group">
									<div class="col-md-12 col-sm-12">
										...
										<input type="date" name="news_date" value="{{ date('Y-m-d') }}" class="form-control required {{ $errors->has('news_date')? 'error' : '' }}">
								...
								<div class="form-group">
									<div class="col-md-12 col-sm-12">
										...
										<textarea name="txt" class="summernote form-control" data-height="200" data-lang="en-US"></textarea>
									</div>
								</div>
							</div>
							<div class="col-md-4">
