...
class MTCPanelPollsAnswersController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.polls.answers';
        $this->route = 'mtCPanel.polls.answers';
        $this->model = new PollAnswer;
        $this->folder = '/includes/polls/';
        $this->paginate = 25;
        $this->privName = 'polls';
        $this->parentModel = new Poll;
   }
    ...
    public function index($parent_id = null){
        ...
        $model = $model->where('poll_id', $parent_id);
