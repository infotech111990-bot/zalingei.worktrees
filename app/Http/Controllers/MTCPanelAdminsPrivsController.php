...
class MTCPanelAdminsPrivsController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.admins.privs';
        $this->route = 'mtCPanel.admins.privs';
        $this->model = new AdminPrivilege;
        $this->folder = '/includes/admins/';
        $this->paginate = 25;
        $this->privName = 'admins';
        $this->parentModel = new Admin;
   }
    ...
    public function index($parent_id = null){
        ...
        $model = $model->where('userID', $parent_id);
    ...
    public function update(Request $request, $parent_id = null, $id = null){
        ...
        $data['dataCreate'] = $request->input('dataCreate');
        $data['dataUpdate'] = $request->input('dataUpdate');
        $data['dataDelete'] = $request->input('dataDelete');
