...
class MTCPanelServicesController extends Controller
{
    ...
    public function __construct(){
        $this->view = 'mtCPanel.services';
        $this->route = 'mtCPanel.services';
        $this->model = new Service;
        $this->folder = '/includes/services/';
        $this->paginate = 25;
        $this->privName = 'services';
    }
